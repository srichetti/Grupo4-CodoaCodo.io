...
const expresiones = {
	...
	Comentario: /^[a-zA-ZÀ-ÿ\s]{1,250}$/ // Letras y espacios.
...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		break;
		case "comentario":
			validarCampo(expresiones.Comentario, e.target, 'comentario');		break;
	}
}
...
formulario.addEventListener('submit', (e) => {
    ...
    if (campos.nombre && campos.telefono && campos.correo && campos.comentario) {
        formulario.reset();
        ...
        setTimeout(() => {
            ...
            const mensajeError = document.getElementById('formulario__mensaje'); // Ocultar mensaje de error
